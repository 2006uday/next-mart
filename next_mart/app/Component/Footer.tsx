...
import apploLogo from "../../assets/apple-store.svg"
...
import customerSupport from "../../assets/customer-service.svg"
...
function Footer() {
  ...
  return (
    <div className=' w-screen fixed bottom-0 right-0 grid grid-cols-5 gap-3 p-4 text-gray-900'>
      {/* div 1 */}
      <div>
        {/* image logo */}
        <Image  src={logo} alt='Next Mart & Grocery' width={175} height={175} />

        {/* tag line */}
        <h2>Awesome grocery store website</h2>

        {/* address */}
        <p className='flex items-start gap-3'><span className='font-bold flex justify-center items-center'><Image src={location} alt='' width={20} />Address:</span> 5171 W Campbell Ave undefined Kent, Utah 53127 United States</p>

        {/* Call us */}
        <p className='flex items-start gap-3'><span className='font-bold flex justify-center items-center'><Image src={customerSupport} alt='' width={20} />Call Us:</span>(+91) - 540-025-124553</p>

        {/* Email */}
        <p className='flex items-start gap-3'><span className='font-bold flex justify-center items-center'><Image src={sendSvg} alt='' width={20} />Email:</span>sale@Next.com</p>

        {/* Hours */}
        <p className='flex items-start gap-3'><span className='font-bold flex justify-center items-center'><Image src={clock} alt='' width={20} className='' />Hours:</span>10:00 - 18:00,Mon - Sat</p>
        ...
        <div className='w-full flex gap-2 my-5'>
          ...
          <motion.button 
            ...
            <Image src={apploLogo} alt='Appple Store' width={25} className=' invert-100' />
          ...
          <motion.button 
            ...
            exit={{y: 0}}
            className='bg-black px-2 py-1 flex justify-center items-center rounded-sm'>
            <Image src={googlePlayLogo} alt='Google Play' width={25} />
        ...
        <Image src={paymentMethods} alt='Payment Methods' width={175} className='my-5' />
